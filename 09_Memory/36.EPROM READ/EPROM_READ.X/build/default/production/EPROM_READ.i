...
void SPI_page_write(unsigned char MSB, unsigned char LSB);
void SPI_read_byte(unsigned char MSB, unsigned char LSB);
char data;
int main()
{
    TRISD = 0x00;
    ...
    send_cmd(0x80);
    show_data("data");
    SPI_page_write(0x00,0x00);
    _delay((unsigned long)((1000)*(20000000/4000.0)));
    send_cmd(0xc0);
    SPI_read_byte(0x00,0x00);
    _delay((unsigned long)((1000)*(20000000/4000.0)));
    while(1);
}
void SPI_master_init()
