...
void keypad(void)
{
    ...
    RB1 = RB2 = RB3 = 1;
    RB0 = 0;
    if (RB4 == 0) { send_dat('7'); a = 7; while(RB4==0); }
    if (RB5 == 0) { send_dat('8'); a = 8; while(RB5==0); }
    if (RB6 == 0) { send_dat('9'); a = 9; while(RB6==0); }
    if (RB7 == 0) { send_dat('/'); c = '/'; b = a; while(RB7==0); }


    RB4 = RB5 = RB6 = RB7 = 1;
    RB0 = RB2 = RB3 = 1;
    RB1 = 0;
    if (RB4 == 0) { send_dat('4'); a = 4; while(RB4==0); }
    if (RB5 == 0) { send_dat('5'); a = 5; while(RB5==0); }
    if (RB6 == 0) { send_dat('6'); a = 6; while(RB6==0); }
    if (RB7 == 0) { send_dat(''); c = ''; b = a; while(RB7==0); }
    ...
    RB0 = RB1 = RB3 = 1;
    RB2 = 0;
    if (RB4 == 0) { send_dat('1'); a = 1; while(RB4==0); }
    if (RB5 == 0) { send_dat('2'); a = 2; while(RB5==0); }
    if (RB6 == 0) { send_dat('3'); a = 3; while(RB6==0); }
    if (RB7 == 0) { send_dat('-'); c = '-'; b = a; while(RB7==0); }
    ...
    RB0 = RB1 = RB2 = 1;
    RB3 = 0;
    if (RB4 == 0) { lcd_init(); show_dat("ENTER A NUMBER"); while(RB4==0); }
    if (RB5 == 0) { send_dat('0'); a = 0; while(RB5==0); }
    if (RB6 == 0) { send_dat('='); calculation(); while(RB6==0); }
    if (RB7 == 0) { send_dat('+'); c = '+'; b = a; while(RB7==0); }
}
